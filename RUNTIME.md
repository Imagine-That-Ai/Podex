...
The installed proxy currently hosts live Codex work. The staged bundle is therefore verified but not hot-swapped during an active task. When handing off safely, restart only `/Applications/Codex CLIProxy.app`; the regular ChatGPT app is out of scope.
